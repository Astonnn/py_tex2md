        ...
        while line != '':
            ...
            if line.startswith('\\put'):
                ...
                if line.startswith('\\line'):
                    ...
                    mdstr += '\t<rect x="' + str(x) + '" y="' + str(height + half_row_spacing - y) + '" width="' + str(math.sqrt(dx * times * dx * times + dy * times * dy * times) ) + '" height="1" transform="rotate(' + str(theta) + ' ' + str(x) + ',' + str(y) + ')"/>\n'
                    ...
                    mdstr += '\t<circle cx="' + str(x) + '" cy="' + str(height + half_row_spacing - y) + '" r="' + str(radius) + '"'
                    if not fill:
                    ...
                    print(line)
                    mdstr += '\t<text x="' + str(x + dx - len(text) * 6) + '" y="' + str(height + half_row_spacing - y - dy) + '">' + text + '</text>\n'
                    print('circleline', line)
